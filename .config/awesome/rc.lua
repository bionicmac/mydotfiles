...
beautiful.init(gfs.get_configuration_dir() .. "themes/darknred/theme.lua")
...
globalkeys = gears.table.join(
    ...
    -- My Bindings
	-- Replace wibox run prompt with dmenu
    ...
    awful.key({}, "XF86AudioMicMute", function () awful.util.spawn_with_shell("pactl -- set-source-mute 1 toggle") end),
    awful.key({}, "XF86AudioMute", function () awful.util.spawn_with_shell("pactl -- set-sink-mute 0 toggle") end),

	-- Enable direction client switching with mod + ctrl + arrows
